...
function Not404Found() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" className={'not-found-logo'}>
			<title>404</title>
			...
			<g id="cup" data-name="Layer 7">
				...
				<g className="cls-10">
					<path className="cls-8" d="M1176.32,667.78h0a4.19,4.19,0,0,1,4.19,4.19v33.54a0,0,0,0,1,0,0h-8.38a0,0,0,0,1,0,0V672a4.19,4.19,0,0,1,4.19-4.19Z"
				...
				<path className="cls-5" d="M1197.85,660.5h45.69a5.7,5.7,0,0,1,5.7,5.7v8.32a0,0,0,0,1,0,0h-57.09a0,0,0,0,1,0,0v-8.32A5.7,5.7,0,0,1,1197.85,660.5Z"
				      transform="translate(829.53 -667.66) rotate(45)"/>
				<path className="cls-8" d="M1191.49,664.74h53.94a5.25,5.25,0,0,1,5.25,5.25v4.79a0,0,0,0,1,0,0h-64.44a0,0,0,0,1,0,0V670a5.25,5.25,0,0,1,5.25-5.25Z"
